...
const steps = [
    {
        title: "Discover",
        description: "Uncover sensitive data across cloud, SaaS, and on-premises environments.",
        icon: Search,
    ...
    {
        title: "Classify",
        description: "Intelligent labeling of PII, PHI, PCI, and proprietary intellectual property.",
        icon: FileText,
    ...
    {
        title: "Govern",
        description: "Enforce retention policies, access controls, and encryption standards.",
        icon: Database,
    ...
    {
        title: "Monitor",
        description: "Continuous oversight of data movement to block exfiltration in real-time.",
        icon: Eye,

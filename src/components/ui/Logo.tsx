        ...
        <div className={`relative ${className} group`}>
            ...
            >
                ...
                <path
                    ...
                    className="text-sf opacity-50 transition-opacity group-hover:opacity-100"
                />
                ...
                {/* Core Glow Point */}
                <circle cx="50" cy="50" r="10" className="fill-dspm animate-pulse" />

                <defs>
                    <linearGradient id="pulse-gradient" x1="30" y1="30" x2="70" y2="80" gradientUnits="userSpaceOnUse">
                        <stop stopColor="var(--color-sf)" />
                        <stop offset="1" stopColor="var(--color-dspm)" />
                    </linearGradient>
                </defs>
            </svg>
